...
{
    public static readonly DateTime AnyDateTime = new(2020, 12, 13, 0, 0, 0, DateTimeKind.Utc);
    public static readonly DateTime AnotherDateTime = new(2020, 12, 4, 0, 0, 0, DateTimeKind.Utc);
